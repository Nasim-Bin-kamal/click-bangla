      ...
      <Container>
        <Grid container spacing={2} sx={{ py: 5, color: "#FFF" }}>
          <Grid item xs={12} md={4} lg={4}>
            <Box variant="h6" noWrap component="div">
              <img
          ...
          <Grid item xs={12} md={2} lg={2}>
            ...
            <List dense>
              ...
              <ListItem>
                <NavLink style={style} to="/contactt">
                  Contact
                </NavLink>
              </ListItem>
              <ListItem>
                <NavLink style={style} to="/team">
                  Our Team
                </NavLink>
              </ListItem>
              <ListItem>
                <NavLink style={style} to="/terms">
                  Terms Conditions
                </NavLink>
              </ListItem>
            </List>
          ...
          <Grid item xs={12} md={2} lg={4}>
            ...
            <Typography variant="body1" sx={{ color: "#e6e6e1", py: 2 }}>
              If you want to know about our updated news, subscribe to our
              newsletter
            </Typography>
            <TextField
              type="email"
            ...
            <Button
              variant="contained"
              sx={{ backgroundColor: "#FFF8F5", color: "#0dbf57", py: 1 }}
            >
              <SendIcon />
            </Button>
          </Grid>
