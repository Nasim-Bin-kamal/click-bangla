    ...
    <div>
      ...
      >
        ...
        >
          <Typography
            variant="h4"
            sx={{ m: "auto", pb: 3, textAlign: "center", color: "#1BAB42" }}
          >
            Login
          </Typography>
          {errorMsg && (
            <Alert sx={{ my: 3 }} severity="error" dismissible>
              {errorMsg}
            </Alert>
          )}
          <form onSubmit={handleUserLogin}>
            ...
            <MyButton
              type="submit"
              sx={{ my: 2, mx: "auto", width: "100%", display: "flex" }}
            >
              Login
            </MyButton>
          </form>
          ...
          >
            ...
            <Typography variant="body2" sx={{ mt: 2 }}>
              ...
              <NavLink
                style={{ color: "#1BAB42", fontWeight: 500 }}
                to="/register"
              >
                Create an account
              </NavLink>
