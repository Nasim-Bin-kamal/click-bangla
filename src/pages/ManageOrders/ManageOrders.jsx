...
const ManageOrders = () => {
  ...
  useEffect(() => {
    fetch("https://click-bangla-server.vercel.app/orders")
      .then((res) => res.json())
      .then((data) => {
        setOrders(data);
        setModifiedCount(0);
  ...
  const handleApproveOrder = (id) => {
    ...
    const url = `https://click-bangla-server.vercel.app/orders/update/${id}`;
            ...
            <Grid item xs={12} key={product?._id}>
              <Paper elevation={1} sx={{ py: 1 }}>
                <Grid container sx={{ mx: "auto" }}>
                  ...
                  >
                    <Button
                      onClick={() => handleApproveOrder(product?._id)}
                      variant="outlined"
                      color="secondary"
                    >
                      Approved
